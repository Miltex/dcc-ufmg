...
As classes de testes de integrações devem estar no diretorio src/test/java. 
Embora não seja uma regra técnica rígida, mas, o sufixo das classes dos testes de integração terminem com *IT.java
Os testes devem ser executados quando rodar o comando no mavem após o ambiente conteinerizado subir e após a construção da imagem do wildfly.
...
## Configuração de Testes de Aceitação - Funcionais
